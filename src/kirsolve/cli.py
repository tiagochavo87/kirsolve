...
def cmd_inspect(args) -> int:
    ...
    df = load_workbook(args.input, sheet_tools=_parse_sheet_tools(args.sheet_tool),
...
def cmd_run(args) -> int:
    ...
    raw = load_workbook(args.input, sheet_tools=_parse_sheet_tools(args.sheet_tool),
                        sample_regex=args.sample_regex)
    if raw.empty:
...
def build_parser() -> argparse.ArgumentParser:
    ...
    common.add_argument("input", help="planilha .xlsx com as saidas das ferramentas")
